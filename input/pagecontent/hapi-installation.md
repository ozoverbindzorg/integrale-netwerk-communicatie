...
- **Latest Release:** [v0.7.3](https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/tag/v0.7.3)
...
```
fhir.ozo-0.7.3-minimal.tgz
```

The full download URL will be:
```
https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.7.3/fhir.ozo-0.7.3-minimal.tgz
```
  ...
  fhir:
    ...
    implementationguides:
      ...
      ozo:
        name: fhir.ozo
        version: 0.7.3
        packageUrl: https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.7.3/fhir.ozo-0.7.3-minimal.tgz
        installMode: STORE_AND_INSTALL
```
...
| **version** | The version of the package to install | `0.7.3` |
...
```
INFO: Installing package fhir.ozo version 0.7.3
...
The `version` field on each returned StructureDefinition reflects the IG package version (e.g., `"version": "0.7.3"`).
...
```bash
wget https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.7.3/fhir.ozo-0.7.3.tgz
```
...
curl -X POST \
  ...
  --data-binary @fhir.ozo-0.7.3.tgz \
