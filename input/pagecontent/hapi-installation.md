...
- **Latest Release:** [v0.8.2](https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/tag/v0.8.2)
...
```
fhir.ozo-0.8.2-minimal.tgz
```

The full download URL will be:
```
https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.8.2/fhir.ozo-0.8.2-minimal.tgz
```
  ...
  fhir:
    ...
    implementationguides:
      ...
      ozo:
        name: fhir.ozo
        version: 0.8.2
        packageUrl: https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.8.2/fhir.ozo-0.8.2-minimal.tgz
        installMode: STORE_AND_INSTALL
```
...
| **version** | The version of the package to install | `0.8.2` |
...
```
INFO: Installing package fhir.ozo version 0.8.2
...
The `version` field on each returned StructureDefinition reflects the IG package version (e.g., `"version": "0.8.2"`).
...
```bash
wget https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.8.2/fhir.ozo-0.8.2.tgz
```
...
curl -X POST \
  ...
  --data-binary @fhir.ozo-0.8.2.tgz \
