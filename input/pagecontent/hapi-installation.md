...
- **Latest Release:** [v0.6.0](https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/tag/v0.6.0)
...
```
fhir.ozo-0.6.0-minimal.tgz
```

The full download URL will be:
```
https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.6.0/fhir.ozo-0.6.0-minimal.tgz
```
  ...
  fhir:
    ...
    implementationguides:
      ...
      ozo:
        name: fhir.ozo
        version: 0.6.0
        packageUrl: https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.6.0/fhir.ozo-0.6.0-minimal.tgz
        installMode: STORE_AND_INSTALL
```
...
| **version** | The version of the package to install | `0.6.0` |
...
```
INFO: Installing package fhir.ozo version 0.6.0
...
The `version` field on each returned StructureDefinition reflects the IG package version (e.g., `"version": "0.6.0"`).
...
```bash
wget https://github.com/ozoverbindzorg/integrale-netwerk-communicatie/releases/download/v0.6.0/fhir.ozo-0.6.0.tgz
```
...
curl -X POST \
  ...
  --data-binary @fhir.ozo-0.6.0.tgz \
