...
def convert_ig_to_package(ig_path='output/ImplementationGuide-fhir.ozo.json', output_path='package.json'):
    ...
    if os.path.exists(output_path):
        ...
        package = {
            "name": "fhir.ozo",
            "description": "OZO FHIR Implementation Guide - minimal package for FHIR servers",
            "title": "OZO FHIR Package",
            "author": "HeadEase",
            "fhirVersions": ["4.0.1"],
            "jurisdiction": "urn:iso:std:iso:3166#NL",
            "maintainers": [{"name": "HeadEase"}, {"name": "OZO"}],
            "keywords": ["OZO", "HeadEase", "Healthcare"]
        }
    ...
    package['name'] = ig.get('id', package.get('name', 'fhir.ozo'))
...
if __name__ == "__main__":
    ...
    ig_path = sys.argv[1] if len(sys.argv) > 1 else 'output/ImplementationGuide-fhir.ozo.json'
